...
class CrackingFront:
    """Pressure-temperature boundary for thermally induced microfracturing."""
    ...
    def __post_init__(self) -> None:
        ...
        if p.size < 2:
            raise ValueError("a cracking front requires at least two P-T points")
...
def load_front(path: str | Path) -> CrackingFront:
    ...
    No smoothing or regridding is performed here.
    """
